...
**Schema:** [`../schema/halos-provenance-v0.1.schema.json`](../schema/halos-provenance-v0.1.schema.json)
...
See [`../../examples/embedded/cyclonedx.json`](../../examples/embedded/cyclonedx.json).

### SLSA

Add as a `predicate` in a SLSA provenance document with `predicateType` set to `https://halos.northharbor.dev/provenance/v0.1`.

See [`../../examples/embedded/slsa.json`](../../examples/embedded/slsa.json).
...
The graph-based model (Entity/Activity/Relationship) is under development in [`v0.2-draft.md`](v0.2-draft.md).
...
3. Validates against [`../schema/halos-provenance-v0.1.schema.json`](../schema/halos-provenance-v0.1.schema.json)
