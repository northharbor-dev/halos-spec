...
How halos-spec evolves through public stewardship, proposals, and review.
...
HALOS is currently founder-led and stewarded in public through the NorthHarbor Development organization.
...
Roles are intentionally lightweight at this stage.
...
6. **Integration** — Accepted proposals are reflected in the relevant spec or doc files
...
- **New specifications** — e.g., a new provenance field, an attribution format
...
3. **Scope** — Is it appropriately scoped?
...
Changes to the principles are held to a higher bar:
...
Transparency is preferred. Rationale for decisions should be documented in issues or pull requests.

---

## Evolution of Governance

This document may itself be updated through the proposal process. Meta-proposals about governance require careful review to avoid capture or conflicts of interest.
